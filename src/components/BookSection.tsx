                ...
                >
                  <AnimatePresence mode="wait">
                    ...
                    >
                      ...
                      {currentPage > 3 && (
                        <motion.div
                          className="absolute inset-0 bg-black/60 backdrop-blur-md flex flex-col items-center justify-center text-center p-6"
                          initial={{ opacity: 0 }}
                          animate={{ opacity: 1 }}
                          transition={{ duration: 0.4 }}
                        >
                          <div className="bg-white/95 backdrop-blur-xl rounded-2xl p-8 sm:p-10 shadow-xl max-w-sm mx-auto border border-white/10">
                            <div className="w-10 h-10 sm:w-12 sm:h-12 mx-auto mb-6 bg-stone-900 rounded-xl flex items-center justify-center">
                            ...
                            <h3 
                              className="text-lg sm:text-xl font-normal text-stone-900 mb-4 tracking-tight"
                              style={{ fontFamily: fonts.heading }}
                            >
                              Interested in this story?
                            </h3>
                            <p 
                              className="text-sm sm:text-base text-stone-600 mb-6 leading-relaxed font-light"
                            ...
                            <a
                              ...
                              className="inline-flex items-center justify-center bg-stone-900 text-white px-7 py-3 rounded-xl font-normal text-sm tracking-wide hover:bg-stone-800 transition-all duration-200 w-full interactive"
                              style={{ fontFamily: fonts.body }}
                            >
